...
const THEMES = [
  "light", "dark", "coffee", "cupcake", "bumblebee", "emerald", 
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
          {THEMES.map((t) => (
            ...
            >
              <div className={`relative h-8 w-full rounded-md overflow-hidden ${t}`}>
                ...
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="p-4 border-t border-base-300 bg-base-100">
                    <div className="flex gap-2">
                      <input
                        type="text"
                        className="flex-1 text-sm h-10 px-3 py-2 rounded-lg border border-base-300 bg-base-100 text-base-content focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                        placeholder="Type a message..."
                        value="This is a preview"
                        readOnly
                      />
                      <button 
                        className="h-10 px-4 rounded-lg bg-primary text-primary-content flex items-center justify-center hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
